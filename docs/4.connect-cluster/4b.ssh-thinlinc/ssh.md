...
!!! NOTE 
    ...
    You can find more examples for file transfers in the [File transfer section on HPC2N's documentation pages](https://docs.hpc2n.umu.se/documentation/filesystems/#file__transfer)
