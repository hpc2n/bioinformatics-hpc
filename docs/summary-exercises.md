...
Work through the exercises in the order that is most useful to you. If you are up to date with everything, use the extension exercises at the bottom of each section.
...
### 2. BLAST and sequence similarity

Use the [BLAST handout](12.blast/blast.md) to:

- Run a BLAST search via the NCBI web interface for a protein of your choice
- Try interpreting the E-values and coverage for your top hits
- If you have access to Kebnekaise: run a local BLAST job against the SwissProt database using the Slurm script in `exercises/12.blast/`
...
If you missed any sessions, work through these in order:

- [ ] [Biological databases](11.database-landscape/database-landscape.md) — INSDC, UniProt, GO, specialist resources
- [ ] [BLAST and sequence similarity](12.blast/blast.md) — local and remote alignment search
...
- [ ] [FAIR in practice](15.fair-in-practice/fair-in-practice.md) — PlantGenIE API, GEO metadata, paper reproducibility

---

## Essay reminder

The FAIR compliance essay deadline is set in Canvas — see the [essay assignment](14.fair-open-science/fair-essay-assignment.md) for the full brief, the deadline, and the paper shortlist. Use today's session to make progress on your paper assessment if you have not already done so.
