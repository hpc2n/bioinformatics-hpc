...
A brief introduction to Linux and some of the most useful commands. 

!!! NOTE

    You can either use your own computer with Linux on, or you can use Kebnekaise (see [Connecting to a cluster](https://hpc2n.github.io/bioinformatics-hpc/4.connect-cluster/connect-cluster.md)). 
...
!!! seealso "See also"
    ...
    - <a href="https://docs.hpc2n.umu.se/tutorials/linuxguide/" target="_blank">https://docs.hpc2n.umu.se/tutorials/linuxguide/</a>
    - <a href="https://swcarpentry.github.io/shell-novice/" target="_blank">Documentation from Software Carpentry</a> 
