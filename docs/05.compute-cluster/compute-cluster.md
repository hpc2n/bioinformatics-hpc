...
designed to handle a wide range of distinct tasks sequentially. (Low latency and low throughput). 

GPUs (Graphics Processing Units) are throughput-optimized specialized processors
designed for high-end parallel computing. (Latency is high and throughput is also high)
...
HPC2N is also part of several projects and collaborations, like <a href="https://essenceofescience.se/" target="_blank">eSSENCE</a>, PRACE, Algoryx, WLCG, EOSC, EISCAT, SciLifeLab, and Skills4EOSC. 
